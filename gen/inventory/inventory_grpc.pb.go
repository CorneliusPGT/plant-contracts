...
const (
	InventoryService_GetPart_FullMethodName   = "/inventory.InventoryService/GetPart"
	InventoryService_ListParts_FullMethodName = "/inventory.InventoryService/ListParts"
)

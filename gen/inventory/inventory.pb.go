...
type Part struct {
	...
	Category      Category               `protobuf:"varint,6,opt,name=category,proto3,enum=inventory.Category" json:"category,omitempty"`
...
type PartsFilter struct {
	...
	Categories            []Category             `protobuf:"varint,3,rep,packed,name=categories,proto3,enum=inventory.Category" json:"categories,omitempty"`
...
const file_inventory_inventory_proto_rawDesc = "" +
	"\n" +
	"\x19inventory/inventory.proto\x12\tinventory\x1a\x1fgoogle/protobuf/timestamp.proto\"j\n" +
	"\n" +
	"Dimensions\x12\x16\n" +
	...
	"\bcategory\x18\x06 \x01(\x0e2\x13.inventory.CategoryR\bcategory\x125\n" +
	"\n" +
	"dimensions\x18\a \x01(\v2\x15.inventory.DimensionsR\n" +
	"dimensions\x125\n" +
	"\n" +
	"manufacter\x18\b \x01(\v2\x15.inventory.ManufacterR\n" +
	"manufacter\x12\x12\n" +
	"\x04tags\x18\t \x03(\tR\x04tags\x129\n" +
	"\bmetadata\x18\n" +
	" \x03(\v2\x1d.inventory.Part.MetadataEntryR\bmetadata\x129\n" +
	"\n" +
	"created_at\x18\v \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\f \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\x1aM\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12&\n" +
	"\x05value\x18\x02 \x01(\v2\x10.inventory.ValueR\x05value:\x028\x01\"\xb9\x01\n" +
	"\vPartsFilter\x12\x14\n" +
	"\x05uuids\x18\x01 \x03(\tR\x05uuids\x12\x14\n" +
	"\x05names\x18\x02 \x03(\tR\x05names\x123\n" +
	"\n" +
	"categories\x18\x03 \x03(\x0e2\x13.inventory.CategoryR\n" +
	"categories\x125\n" +
	...
	"\x04part\x18\x01 \x01(\v2\x0f.inventory.PartR\x04part\"B\n" +
	"\x10ListPartsRequest\x12.\n" +
	"\x06filter\x18\x01 \x01(\v2\x16.inventory.PartsFilterR\x06filter\":\n" +
	"\x11ListPartsResponse\x12%\n" +
	"\x05parts\x18\x01 \x03(\v2\x0f.inventory.PartR\x05parts*r\n" +
	"\bCategory\x12\x14\n" +
	...
	"\rCATEGORY_WING\x10\x042\x9c\x01\n" +
	"\x10InventoryService\x12@\n" +
	"\aGetPart\x12\x19.inventory.GetPartRequest\x1a\x1a.inventory.GetPartResponse\x12F\n" +
	"\tListParts\x12\x1b.inventory.ListPartsRequest\x1a\x1c.inventory.ListPartsResponseBEZCgithub.com/CorneliusPGT/plant-contracts/gen/inventorypb;inventorypbb\x06proto3"
...
var file_inventory_inventory_proto_goTypes = []any{
	...
	(*Dimensions)(nil),            // 1: inventory.Dimensions
	(*Manufacter)(nil),            // 2: inventory.Manufacter
	(*Value)(nil),                 // 3: inventory.Value
	(*Part)(nil),                  // 4: inventory.Part
	(*PartsFilter)(nil),           // 5: inventory.PartsFilter
	(*GetPartRequest)(nil),        // 6: inventory.GetPartRequest
	(*GetPartResponse)(nil),       // 7: inventory.GetPartResponse
	(*ListPartsRequest)(nil),      // 8: inventory.ListPartsRequest
	(*ListPartsResponse)(nil),     // 9: inventory.ListPartsResponse
	nil,                           // 10: inventory.Part.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 11: google.protobuf.Timestamp
}
var file_inventory_inventory_proto_depIdxs = []int32{
	0,  // 0: inventory.Part.category:type_name -> inventory.Category
	1,  // 1: inventory.Part.dimensions:type_name -> inventory.Dimensions
	2,  // 2: inventory.Part.manufacter:type_name -> inventory.Manufacter
	10, // 3: inventory.Part.metadata:type_name -> inventory.Part.MetadataEntry
	11, // 4: inventory.Part.created_at:type_name -> google.protobuf.Timestamp
	11, // 5: inventory.Part.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 6: inventory.PartsFilter.categories:type_name -> inventory.Category
	4,  // 7: inventory.GetPartResponse.part:type_name -> inventory.Part
	5,  // 8: inventory.ListPartsRequest.filter:type_name -> inventory.PartsFilter
	4,  // 9: inventory.ListPartsResponse.parts:type_name -> inventory.Part
	3,  // 10: inventory.Part.MetadataEntry.value:type_name -> inventory.Value
	6,  // 11: inventory.InventoryService.GetPart:input_type -> inventory.GetPartRequest
	8,  // 12: inventory.InventoryService.ListParts:input_type -> inventory.ListPartsRequest
	7,  // 13: inventory.InventoryService.GetPart:output_type -> inventory.GetPartResponse
	9,  // 14: inventory.InventoryService.ListParts:output_type -> inventory.ListPartsResponse

...
const file_payment_payment_proto_rawDesc = "" +
	"\n" +
	"\x15payment/payment.proto\x12\apayment\"\x8c\x01\n" +
	...
	"\x0eINVESTOR_MONEY\x10\x042Q\n" +
	"\x0ePaymentService\x12?\n" +
	"\bPayOrder\x12\x18.payment.PayOrderRequest\x1a\x19.payment.PayOrderResponseBAZ?github.com/CorneliusPGT/plant-contracts/gen/paymentpb;paymentpbb\x06proto3"
...
var file_payment_payment_proto_goTypes = []any{
	...
	(*PayOrderRequest)(nil),  // 1: payment.PayOrderRequest
	(*PayOrderResponse)(nil), // 2: payment.PayOrderResponse
}
var file_payment_payment_proto_depIdxs = []int32{
	0, // 0: payment.PayOrderRequest.payment_method:type_name -> payment.PaymentMethod
	1, // 1: payment.PaymentService.PayOrder:input_type -> payment.PayOrderRequest
	2, // 2: payment.PaymentService.PayOrder:output_type -> payment.PayOrderResponse
